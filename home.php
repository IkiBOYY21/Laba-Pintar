...
<div class="landing-wrapper">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <a href="<?= BASE_URL ?>auth/register.php" class="btn btn-lg btn-primary fw-bold px-4 py-3">
                            Mulai Sekarang <i class="bi bi-arrow-right"></i>
                        </a>
                        <a href="<?= BASE_URL ?>service.php" class="btn btn-lg btn-outline-light px-4 py-3">
                            Lihat Fitur
                        </a>
                    </div>
                </div>
    ...
    <div class="container-fluid app-container py-5">
        ...
        <div class="row g-5"> <div class="col-md-4">
                <div class="app-card interactive-card p-4 h-100"> <i class="bi bi-cart-check-fill text-primary fs-1 mb-3"></i> <h5 class="fw-bold text-color">Manajemen Penjualan</h5>
